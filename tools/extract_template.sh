...
xgettext *.php */*.php --copyright-holder='Additionalalerts Development Team' --package-name='GLPI - Additionalalerts plugin' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
